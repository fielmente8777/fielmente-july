      ...
      <div className="flex justify-center items-center">
        <div className="space-y-4 w-full mx-auto px-4 py-3 border rounded bg-white">
          ...
          <div className="flex flex-col gap-2">
            <label className="font-semibold text-sm text-primary2">
            ...
            <div className="flex items-center gap-2">
              <div
                className="px-4 py-2 bg-gray-200 text-black font-bold tracking-widest text-lg select-none rounded relative overflow-hidden"
                style={{
                  letterSpacing: "4px",
