...
const FormOld = () => {
  ...
  return (
    ...
    >
      ...
      <button className="w-full text-center bg-[#f26633] text-white justify-center border-[#f26633] text-md px-8 py-2  font-semibold rounded-md hover:bg-white hover:text-orange-primary duration-300 active:scale-75 hover:scale-105 border border-blue-primary">
