...
import { OutLineEmail } from "@/utils/OldFormIcons";
...
const LandingHeader = () => {
  ...
  return (
    <>
      <header
        className="py-3 fixed top-0 left-0 right-0 z-[100] bg-white"
        style={{ boxShadow: " 0px 7px 29px 0px rgba(100, 100, 111, 0.20)" }}
      >
        <nav className="max_width flex justify-between">
          <button
            onClick={() => {
