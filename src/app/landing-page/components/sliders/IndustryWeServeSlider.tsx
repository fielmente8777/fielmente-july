...
import IndustryWeServeCard from "@/components/cards/IndustryWeServeCard";
    ...
    <div className="relative mt-12">
      <Container>
        ...
        <div className="flex items-center justify-between w-full gap-6 absolute z-10 top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 max-w-[96%]">
          ...
          <button className="w-10 aspect-square rounded-full bg-color4 disabled:bg-[#494949] flex items-center justify-center industries-next">
            <Foo />
          </button>
        </div>
      </Container>
