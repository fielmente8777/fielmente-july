...
export const industriesWeServePageData = {
  ...
  WhyFielmente: {
    title: "Why Fielmente Hospitality Marketing?",
    description: `Unseal limitless possibilities with Fielmente’s tailored expertise and results driven solutions! Our hospitality digital marketing services cater precisely to the industries we serve, empowering your success.`,
  },
