...
const ChooseUs: React.FC<ChooseUsPropsType> = ({ title, subTitle, cards }) => {
  return (
    <SectionWithContainer sectionClassName="relative before:content-[''] before:-right-2 overflow-hidden before:bottom-4 before:bg-[url('/home/waves.png')] before:bg-contain before:bg-no-repeat before:w-[153px] before:h-[30px] before:z-[-1] before:absolute">
